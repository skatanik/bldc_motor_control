...
#define RS                     6.10 /* Stator resistance , ohm*/
#define LS                     0.000091 /* Stator inductance, H
...
#define NOMINAL_CURRENT         543
#define MOTOR_MAX_SPEED_RPM     300 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  7.7 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -543 /*!< Demagnetization current */
